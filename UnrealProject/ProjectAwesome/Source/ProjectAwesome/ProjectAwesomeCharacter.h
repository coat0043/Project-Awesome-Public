...
Comment / Description : Player character
ChangeLog :
2 / 14 / 2021 : BasicPickupObject class and functions added
*/
#include "CoreMinimal.h"
#include "GameFramework/Character.h"
#include "ProjectAwesomeCharacter.generated.h"

class ABasicPickupObject;
class UInputComponent;

UCLASS()
class AProjectAwesomeCharacter : public ACharacter
{
	GENERATED_BODY()
...
protected:
	//Holds Item
    ABasicPickupObject* CurrentItem;
...
private:
	...
	class AOutOfBoundsWall* OverLappedWall = nullptr;
